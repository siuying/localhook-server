require './application'
Localhook::Application.initialize!

# Development middlewares
if Localhook::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => Localhook::Application.root(:public)
end
...
#
run Localhook::Application.routes
